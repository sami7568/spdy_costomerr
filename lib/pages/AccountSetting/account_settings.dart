...
import 'package:spdycustomers/pages/AccountSetting/edit_setting.dart';
              ...
              children: [
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text("Account Settings", style: TextStyle(fontSize: 24, color: Colors.white , fontWeight: FontWeight.bold),),
                      ...
                      Center(
                        child: GestureDetector(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context) => const EditSetting()));
                          },
                          child: Container(
                            width: 280,
                            height: 60,
